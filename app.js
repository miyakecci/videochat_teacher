...
$(function() {
    ...
    const APIKEY = 'ab56d3a7-9213-4354-b075-a939e8216893';
...
var count_value = 0;
document.getElementById('xyz123').addEventListener('click',function() {
  count_value += 1;
  if(count_value%3===1){
    document.getElementById('xyz123').style.background = 'red';
  }
  if(count_value%3===2){
    document.getElementById('xyz123').style.background = 'yellow';
    }
  if(count_value%3===0){
    document.getElementById('xyz123').style.background = 'blue';
    }
});